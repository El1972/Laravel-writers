...
<div class="row" id="proBanner">
    <div class="col-12">
      <span class="d-flex align-items-center purchase-popup">
        ...
        <a href="{{asset('https://www.bootstrapdash.com/product/celestial-admin-template/?utm_source=organic&utm_medium=banner&utm_campaign=free-preview')}}" target="_blank" class="btn download-button purchase-button ml-auto">Upgrade To Pro</a>
