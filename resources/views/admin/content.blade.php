      ...
      <li class="nav-item">
        <div class="d-flex sidebar-profile">
          <div class="sidebar-profile-image">
            <img src="/backend/images/faces/face29.png" alt="image">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/backend/ui-features/buttons.html">Buttons</a></li>
            <li class="nav-item"> <a class="nav-link" href="/backend/ui-features/dropdowns.html">Dropdowns</a></li>
            <li class="nav-item"> <a class="nav-link" href="/backend/ui-features/typography.html">Typography</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="form-elements">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"><a class="nav-link" href="/backend/pages/forms/basic_elements.html">Basic Elements</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="charts">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/backend/pages/charts/chartjs.html">ChartJs</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="tables">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/backend/pages/tables/basic-table.html">Basic table</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="icons">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/backend/pages/icons/mdi.html">Mdi icons</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/backend/pages/samples/login.html"> Login </a></li>
            <li class="nav-item"> <a class="nav-link" href="/backend/pages/samples/register.html"> Register </a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="error">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/backend/pages/samples/error-404.html"> 404 </a></li>
            <li class="nav-item"> <a class="nav-link" href="/backend/pages/samples/error-500.html"> 500 </a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/backend/pages/documentation/documentation.html">
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        <td>
                          <div class="d-flex">
                            <img class="img-sm rounded-circle mb-md-0 mr-2" src="/backend/images/faces/face30.png" alt="profile image">
                            <div>
                              <div> Company</div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex">
                            <img class="img-sm rounded-circle mb-md-0 mr-2" src="/backend/images/faces/face31.png" alt="profile image">
                            <div>
                              <div> Company</div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex">
                            <img class="img-sm rounded-circle mb-md-0 mr-2" src="/backend/images/faces/face32.png" alt="profile image">
                            <div>
                              <div> Company</div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex">
                            <img class="img-sm rounded-circle mb-md-0 mr-2" src="/backend/images/faces/face33.png" alt="profile image">
                            <div>
                              <div> Company</div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex">
                            <img class="img-sm rounded-circle mb-md-0 mr-2" src="/backend/images/faces/face34.png" alt="profile image">
                            <div>
                              <div> Company</div>
                              <div class="font-weight-bold  mt-1">volkswagen</div>
                            </div>
